...
package live.cnaidai.com.ccyb.weight.refreshlayout;
...
import live.cnaidai.com.ccyb.weight.refreshlayout.util.BGARefreshScrollingUtil;
    ...
    public void endLoadingMore() {
        if (mIsLoadingMore) {
            if (mIsShowLoadingMoreView) {
                ...
                mHandler.postDelayed(mDelayHiddenLoadingMoreViewTask, 1000);
            } else {

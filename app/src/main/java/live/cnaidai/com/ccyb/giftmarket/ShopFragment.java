...
public class ShopFragment extends BaseFragment<GiftMarketPresenter, GiftMarketModel> implements GiftMarketContract.View {
    ...
    public void initPresenter() {
        mPresenter.setVM(ShopFragment.this, mModel);
    }

 ...
 * @Package com.aidai.view
 * @Description:从底部弹出或滑出选择菜单或窗口
 * @author: lujs
 * @date: 2015年8月17日 下午17:04:01
 */
public class SelectPicPopupWindow extends PopupWindow {

    private LinearLayout mLlHejiu, mLlGuanying;
    ...
    public SelectPicPopupWindow(Context context, OnClickListener itemsOnClick) {
        ...
        mLlHejiu = (LinearLayout) mMenuView.findViewById(R.id.ll_qinghejiu);
        mLlGuanying = (LinearLayout) mMenuView.findViewById(R.id.ll_qingkandianying);
        mTvCancel = (TextView) mMenuView.findViewById(R.id.tv_cancel);
        // 设置按钮监听
        mLlHejiu.setOnClickListener(itemsOnClick);
        mLlGuanying.setOnClickListener(itemsOnClick);
